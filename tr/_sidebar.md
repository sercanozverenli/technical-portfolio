...
<ul>
 <li><a href="#/tr/projects/apps/gamified-multiplication-tool">Oyunlaştırılmış Çarpım Tablosu <span class="badge active">Aktif</span></a></li>
     ...
     <ul>
       <li>
         <details>
           ...
           <ul>
             <li><a href="#/tr/projects/systems/amplify-core/research/conceptual-framework">Kavramsal Çerçeve <span class="badge active">Aktif</span></a></li>
             <li><a href="#/tr/projects/systems/amplify-core/research/literature-and-gap-analysis">Literatür ve Gap Analizi <span class="badge active">Aktif</span></a></li>
